   ...
   struct compressed_matrix<float, 8>
   {
    ...
    static void init()
    {
      ...
      if (!init_done[context_.handle().get()])
      {
        ...
        prog_.add_kernel("unit_lu_forward");
        prog_.add_kernel("lu_backward");
        prog_.add_kernel("trans_lu_backward");
        prog_.add_kernel("unit_lu_backward");
        prog_.add_kernel("lu_forward");
        prog_.add_kernel("trans_unit_lu_backward");
        prog_.add_kernel("jacobi");
        prog_.add_kernel("trans_lu_forward");
        prog_.add_kernel("row_info_extractor");
        prog_.add_kernel("vec_mul");
        prog_.add_kernel("trans_unit_lu_forward");
        prog_.add_kernel("block_trans_lu_backward");
        prog_.add_kernel("trans_unit_lu_forward_slow");
        prog_.add_kernel("block_trans_unit_lu_forward");

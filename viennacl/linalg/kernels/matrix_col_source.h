...
"}\n"
; //matrix_col_align1_ambm_m_cpu_gpu
...
"    + C[(row * C_inc1 + C_start1) + (col * C_inc2 + C_start2) * C_internal_size1] * beta;\n"
"}\n"
; //matrix_col_align1_ambm_m_cpu_cpu
...
"    + C[(row * C_inc1 + C_start1) + (col * C_inc2 + C_start2) * C_internal_size1] * beta;\n"
"}\n"
; //matrix_col_align1_ambm_m_gpu_cpu
...
"    + C[(row * C_inc1 + C_start1) + (col * C_inc2 + C_start2) * C_internal_size1] * beta;\n"
"}\n"
; //matrix_col_align1_ambm_gpu_gpu
...
"  }\n"
"}\n"
; //matrix_col_align1_scaled_rank1_update_gpu
...
"  }\n"
"}\n"
; //matrix_col_align1_triangular_substitute_inplace
...
"    + C[(row * C_inc1 + C_start1) + (col * C_inc2 + C_start2) * C_internal_size1] * beta;\n"
"}\n"
; //matrix_col_align1_ambm_m_gpu_gpu
...
"    + C[(row * C_inc1 + C_start1) + (col * C_inc2 + C_start2) * C_internal_size1] * beta;\n"
"}\n"
; //matrix_col_align1_ambm_gpu_cpu
...
"    + C[(row * C_inc1 + C_start1) + (col * C_inc2 + C_start2) * C_internal_size1] * beta;\n"
"}\n"
; //matrix_col_align1_ambm_cpu_cpu
...
"    + C[(row * C_inc1 + C_start1) + (col * C_inc2 + C_start2) * C_internal_size1] * beta;\n"
"}\n"
; //matrix_col_align1_ambm_cpu_gpu
...
"  }\n"
"}\n"
; //matrix_col_align1_scaled_rank1_update_cpu
...
"}\n"
; //matrix_col_align1_diagonal_assign_cpu

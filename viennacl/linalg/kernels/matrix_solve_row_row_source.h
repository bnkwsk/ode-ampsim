#ifndef VIENNACL_LINALG_KERNELS_MATRIX_SOLVE_ROW_ROW_SOURCE_HPP_
#define VIENNACL_LINALG_KERNELS_MATRIX_SOLVE_ROW_ROW_SOURCE_HPP_
//Automatically generated file from auxiliary-directory, do not edit manually!
/** @file matrix_solve_row_row_source.h
...
"    if (get_local_id(0) == 0) \n"
"      B[(row * B_inc1 + B_start1) * B_internal_size2 + (get_group_id(0) * B_inc2 + B_start2)] /= A[(row * A_inc1 + A_start1) * A_internal_size2 + (row * A_inc2 + A_start2)];\n"
"    barrier(CLK_GLOBAL_MEM_FENCE); \n"
...
"      B[(elim * B_inc1 + B_start1) * B_internal_size2 + (get_group_id(0) * B_inc2 + B_start2)] -= temp * A[(row * A_inc1 + A_start1) * A_internal_size2 + (elim * A_inc2 + A_start2)];\n"
"   }\n"
"}\n"
...
"    barrier(CLK_GLOBAL_MEM_FENCE); \n"
"    if (get_local_id(0) == 0) \n"
"      B[(get_group_id(0) * B_inc1 + B_start1) * B_internal_size2 + (row * B_inc2 + B_start2)] /= A[(row * A_inc1 + A_start1) * A_internal_size2 + (row * A_inc2 + A_start2)];\n"
"    barrier(CLK_GLOBAL_MEM_FENCE); \n"
"    temp = B[(get_group_id(0) * B_inc1 + B_start1) * B_internal_size2 + (row * B_inc2 + B_start2)]; \n"
"    //eliminate column of op(A) with index 'row' in parallel: \n"
"    for  (unsigned int elim = get_local_id(0); elim < row; elim += get_local_size(0)) \n"
"      B[(get_group_id(0) * B_inc1 + B_start1) * B_internal_size2 + (elim * B_inc2 + B_start2)] -= temp * A[(elim * A_inc1 + A_start1) * A_internal_size2 + (row * A_inc2 + A_start2)];\n"
"   }\n"
"}\n"
...
"    //eliminate column of op(A) with index 'row' in parallel: \n"
"    for  (unsigned int elim = get_local_id(0); elim < row; elim += get_local_size(0)) \n"
"      B[(get_group_id(0) * B_inc1 + B_start1) * B_internal_size2 + (elim * B_inc2 + B_start2)] -= temp * A[(row * A_inc1 + A_start1) * A_internal_size2 + (elim * A_inc2 + A_start2)];\n"
"   }\n"
"}\n"
...
"    //eliminate column of op(A) with index 'row' in parallel: \n"
"    for  (unsigned int elim = get_local_id(0); elim < row; elim += get_local_size(0)) \n"
"      B[(elim * B_inc1 + B_start1) * B_internal_size2 + (get_group_id(0) * B_inc2 + B_start2)] -= temp * A[(elim * A_inc1 + A_start1) * A_internal_size2 + (row * A_inc2 + A_start2)];\n"
"   }\n"
"}\n"

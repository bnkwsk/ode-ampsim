#ifndef VIENNACL_MATRIX_PROD_COL_ROW_ROW_KERNELS_HPP_
#define VIENNACL_MATRIX_PROD_COL_ROW_ROW_KERNELS_HPP_
...
/** @file matrix_prod_col_row_row_kernels.h
    ...
    static void init()
    {
      ...
      if (!init_done[context_.handle().get()])
      {
        ...
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(matrix_prod_col_row_row_align1_prod_TT_amd);
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(matrix_prod_col_row_row_align1_prod_AA_amd);
        source.append(matrix_prod_col_row_row_align1_prod16_AT);
        source.append(matrix_prod_col_row_row_align1_prod_TA);
        source.append(matrix_prod_col_row_row_align1_prod16_AA);
        source.append(matrix_prod_col_row_row_align1_prod16_TA);
        source.append(matrix_prod_col_row_row_align1_prod_TT);
        source.append(matrix_prod_col_row_row_align1_prod16_TT);
        source.append(matrix_prod_col_row_row_align1_prod_AT);
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(matrix_prod_col_row_row_align1_prod_AT_amd);
        source.append(matrix_prod_col_row_row_align1_prod_AA);
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(matrix_prod_col_row_row_align1_prod_TA_amd);
   ...
   struct matrix_prod_col_row_row<double, 1>
   {
    ...
    static void init()
    {
      ...
      if (!init_done[context_.handle().get()])
      {
        ...
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_TT_amd, fp64_ext));
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_AA_amd, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod16_AT, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_TA, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod16_AA, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod16_TA, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_TT, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod16_TT, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_AT, fp64_ext));
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_AT_amd, fp64_ext));
        source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_AA, fp64_ext));
        if (viennacl::ocl::current_device().local_memory() > 20000)
          source.append(viennacl::tools::make_double_kernel(matrix_prod_col_row_row_align1_prod_TA_amd, fp64_ext));
        std::string prog_name = program_name();
        #ifdef VIENNACL_BUILD_INFO
        std::cout << "Creating program " << prog_name << std::endl;
        #endif
